...
export const updates: UpdateEntry[] = [
  { date: "2026-05-20", product: "S.A.H Ultimate 8.7", version: "v8.7.0", type: "release", title: "Major Release: Workflow Engine v2", changes: ["Rebuilt automation engine from ground up", "50% faster task execution", "New drag-and-drop workflow builder", "Improved mobile companion app"] },
  ...
  { date: "2026-Q4", product: "S.A.H Mobile", version: "upcoming", type: "roadmap", title: "Mobile App Launch (Q4 2026)", changes: ["Native iOS and Android apps", "Biometric authentication", "Offline mode support"] },
